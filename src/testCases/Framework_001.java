...
public class Framework_001 {
	...
	@Test
	public void VerificationDuringCall() throws Exception {
		...
		try {
			...
			Cookie getSessionID = driver.manage().getCookieNamed("SessionID");
			System.out.println("Page SessionID is: " +getSessionID);
			Cookie getUserToken = driver.manage().getCookieNamed("UserToken");
			System.out.println("Page SessionID is: " +getUserToken);
			//driver.manage();
			//LogOut_Action.ExecuteLogOut();
			ManualCall_Actions.DialManualCall();
			Finalize_Action.finalizationProcess();
